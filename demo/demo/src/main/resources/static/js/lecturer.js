...
document.getElementById("searchBtn").addEventListener("click", function () {
  let lecturer = document.getElementById("searchLecturer").value;

  let subject = document.getElementById("searchSubject").value;

  if (lecturer !== "") {
    fetch("/api/lecturers/search?keyword=" + encodeURIComponent(lecturer))
      .then((res) => res.json())
  ...
  if (subject !== "") {
    fetch(
      "/api/lecturers/search/subject?subject=" + encodeURIComponent(subject),
    )
      .then((res) => res.json())
