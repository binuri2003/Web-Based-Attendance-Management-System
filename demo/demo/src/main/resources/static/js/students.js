...
document.getElementById("searchBtn").addEventListener("click", function () {
  let keyword = document.getElementById("searchStudent").value.trim();
  ...
  if (className !== "") {
    fetch(
      "/api/students/search/class?className=" + encodeURIComponent(className),
    )
      .then((res) => res.json())
  ...
  if (stream !== "") {
    fetch("/api/students/search/stream?stream=" + encodeURIComponent(stream))
      .then((res) => res.json())
...
document
  ...
  .addEventListener("submit", function (e) {
    ...
    let student = {
      ...
      registrationNo: document.getElementById("editRegistrationNo").value,
